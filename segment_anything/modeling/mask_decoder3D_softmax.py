...
class MaskDecoderSoftmax(nn.Module):
    def __init__(
            self,
            *,
            transformer_dim: int,
        ...
        num_classes = num_classes + 1  # Add one for the background class
        ...
        self.final_conv = nn.Conv3d(transformer_dim // 8, num_classes, kernel_size=1)
    ...
    def predict_masks(
        ...
        masks = self.final_conv(upscaled_embedding)
